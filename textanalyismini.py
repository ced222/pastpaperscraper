...
paperPath = cwd + "\\past papers\\Computer Science - 9618\\{}\\{}.pdf".format((str(paperSeries)), ("9618_" + paperSeason[0].lower() + str(paperSeries)[2:] + "_" +"qp" + "_" + str(paper) + str(paperVariant)))
...
for question in questions:
    ...
    for key, value in listOfMatches.items():
        ...
        if value == max(listOfMatches.values()):
            max_key = key
            break
    print(question[1], "Question " + question[0] + " topic is: Chapter {}".format(max_key))